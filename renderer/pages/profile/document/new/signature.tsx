...
const Signature = () => {
    ...
    return( 
            <Style>
              <div className='signature-main p-md-5 p-2 d-flex flex-column position-relative align-items-md-center justify-content-md-center'>
                    <div className='w-100 d-flex justify-content-center'>
                      <BreadCrumb activekey='signature'/>
                    </div>
                    <div className='m-md-5 text-center signature-upload-box p-md-5 p-3 d-flex align-items-center flex-column position-relative'>
                      ...
                      <div className='py-3'>
                          ...
                          onClick={() => {
                            if(progress >= 100){
                              router.push('/profile/document/new/parties');
                            }
                          }}
                           disabled={progress < 100} style={{height:55,fontSize:16,fontWeight:'bold'}} className='px-4' text={ <p className='m-0'>مرحله بعد <ArrowLeft className='mr-1' style={{fontSize:20}}/></p> } />
                      </div>
                      </>
                      }
                    </div>
